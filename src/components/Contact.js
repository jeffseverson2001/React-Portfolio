    ...
    return (
        <div className="container is-fluid">
            ...
            <div className="content has-text-left is-size-6 m-6">
                <a href="/contact" className="white-text"><FontAwesomeIcon icon={faPhone} size='1x' /> 763-220-0777</a>
                <br />
                ...
                <br />
                <a href="https://github.com/jeffseverson2001" className="white-text" target="_blank" rel="noopener noreferrer">
